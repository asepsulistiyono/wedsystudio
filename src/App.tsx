  ...
  return (
    <section className="section-padding bg-[#faf7f2] leaf-pattern">
      <div className="max-w-4xl mx-auto text-center">
        ...
        <p className="font-elegant text-lg text-gray-600 max-w-2xl mx-auto mb-12 leading-relaxed">
        ...
        <p className="font-elegant text-[#c9a96e] text-lg mb-16">— QS. Ar-Rum: 21 —</p>
          ...
          <div className="text-center">
            <div className="w-48 h-48 mx-auto mb-6 rounded-full overflow-hidden border-4 border-[#c9a96e] shadow-lg">
              <div className="w-full h-full bg-gradient-to-br from-[#2d4a3e] to-[#1a3a2e] flex items-center justify-center">
                <span className="font-script text-5xl text-[#e8d5a3]">A</span>
              </div>
            </div>
            <h3 className="font-script text-4xl text-[#2d4a3e] mb-2">Ahmad Rizky</h3>
            <p className="font-elegant text-gray-600 text-lg mb-2">Putra pertama dari</p>
            <p className="font-display text-gray-700">Bapak H. Muhammad Hasan</p>
            <p className="font-display text-gray-700">&</p>
            <p className="font-display text-gray-700">Ibu Hj. Siti Aisyah</p>
          </div>

          {/* Ampersand */}
          <div className="hidden md:block absolute left-1/2 transform -translate-x-1/2">
            <span className="font-script text-6xl text-[#c9a96e]">&</span>
          </div>
          <div className="md:hidden">
            <span className="font-script text-5xl text-[#c9a96e]">&</span>
          </div>
          ...
          <div className="text-center">
            <div className="w-48 h-48 mx-auto mb-6 rounded-full overflow-hidden border-4 border-[#c9a96e] shadow-lg">
              <div className="w-full h-full bg-gradient-to-br from-[#c9a96e] to-[#a88a52] flex items-center justify-center">
                <span className="font-script text-5xl text-white">F</span>
              </div>
            </div>
            <h3 className="font-script text-4xl text-[#2d4a3e] mb-2">Fatimah Azzahra</h3>
            <p className="font-elegant text-gray-600 text-lg mb-2">Putri kedua dari</p>
            <p className="font-display text-gray-700">Bapak H. Abdullah Rahman</p>
            <p className="font-display text-gray-700">&</p>
            <p className="font-display text-gray-700">Ibu Hj. Nurhaliza</p>
          </div>
        </div>
      </div>
    </section>
...
function CountdownSection() {
  ...
  useEffect(() => {
    const weddingDate = new Date('2025-03-15T08:00:00');
        ...
        <div className="grid md:grid-cols-2 gap-8">
          ...
          <div className="glass-card p-8 text-center hover:shadow-xl transition-shadow duration-300">
            ...
            <div className="space-y-3">
              <p className="font-elegant text-gray-600 text-lg">
                <span className="font-semibold text-[#2d4a3e]">Sabtu,</span> 15 Maret 2025
              </p>
              <p className="font-elegant text-gray-600 text-lg">
                Pukul <span className="font-semibold text-[#2d4a3e]">08.00 WIB</span> - Selesai
              </p>
              <div className="pt-3 border-t border-[#c9a96e]/30">
                <p className="font-display text-[#2d4a3e] font-semibold">Masjid Al-Ikhlas</p>
                <p className="font-elegant text-gray-500">Jl. Merdeka No. 123, Jakarta Selatan</p>
              </div>
            </div>
          </div>
          ...
          <div className="glass-card p-8 text-center hover:shadow-xl transition-shadow duration-300">
            ...
            <div className="space-y-3">
              ...
              <p className="font-elegant text-gray-600 text-lg">
                Pukul <span className="font-semibold text-[#2d4a3e]">11.00 - 14.00 WIB</span>
              </p>
              <div className="pt-3 border-t border-[#c9a96e]/30">
                <p className="font-display text-[#2d4a3e] font-semibold">Ballroom Hotel Grand Royal</p>
                <p className="font-elegant text-gray-500">Jl. Sudirman No. 45, Jakarta Pusat</p>
              </div>
            </div>
          </div>
        </div>
...
function LoveStorySection() {
  const stories = [
    { year: '2019', title: 'Pertama Bertemu', desc: 'Kami pertama kali bertemu di sebuah acara kampus. Senyummu yang tulus membuatku tak bisa melupakanmu.' },
    { year: '2020', title: 'Mulai Dekat', desc: 'Dari teman menjadi sahabat. Kita sering bertukar cerita dan saling mendukung dalam setiap langkah.' },
    { year: '2022', title: 'Menjalin Hubungan', desc: 'Dengan bismillah, kami memutuskan untuk menjalin hubungan yang lebih serius dengan restu keluarga.' },
    { year: '2024', title: 'Lamaran', desc: 'Alhamdulillah, dengan penuh keberkahan kami melangsungkan acara lamaran disaksikan kedua keluarga.' },
    { year: '2025', title: 'Pernikahan', desc: 'Insya Allah, kami akan menyempurnakan separuh agama dan memulai lembaran baru bersama.' },
  ];
    ...
    return (
      <section className="section-padding bg-[#f0ebe3]">
        <div className="max-w-lg mx-auto text-center glass-card p-10">
          ...
          <p className="font-elegant text-gray-600 text-lg">Konfirmasi Anda telah kami terima. Semoga bisa bertemu di hari bahagia kami.</p>
        </div>
      </section>
    );
  }
  ...
  return (
    <section className="section-padding bg-[#f0ebe3]">
      <div className="max-w-lg mx-auto text-center">
        ...
        <p className="font-elegant text-gray-600 mb-8">Mohon konfirmasi kehadiran Bapak/Ibu/Saudara/i</p>
...
function WishesSection() {
  const [wishes, setWishes] = useState([
    { name: 'Budi Santoso', message: 'Barakallahu lakuma wa baraka \'alaikuma wa jama\'a bainakuma fi khair. Semoga menjadi keluarga yang sakinah, mawaddah, warahmah!', time: '2 jam lalu' },
    { name: 'Dewi Lestari', message: 'Selamat menempuh hidup baru! Semoga selalu diberkahi Allah SWT dan menjadi pasangan yang saling melengkapi. Aamiin 🤲', time: '5 jam lalu' },
    { name: 'Rina Marlina', message: 'MasyaAllah, bahagia sekali melihat kalian. Semoga pernikahannya penuh berkah dan kebahagiaan selalu menyertai. Love you both! 💕', time: '1 hari lalu' },
  ]);
  ...
  return (
    <section className="section-padding bg-[#faf7f2]">
      <div className="max-w-2xl mx-auto text-center">
        <p className="font-elegant text-[#c9a96e] text-lg tracking-widest uppercase mb-2">Wishes</p>
        <h2 className="font-display text-3xl md:text-4xl text-[#2d4a3e] mb-4">Ucapan & Doa</h2>
        <div className="ornament-divider mb-8">
          <span className="text-[#c9a96e]">✦</span>
        </div>
        ...
        <button
          ...
          className="mb-8 px-6 py-3 bg-[#c9a96e] text-white rounded-full font-elegant text-lg hover:bg-[#a88a52] transition-colors duration-300"
        >
          ✍ Kirim Ucapan & Doa
        </button>

        {showForm && (
          <form onSubmit={addWish} className="glass-card p-6 mb-8 text-left space-y-4 animate-fade-in">
            <input
              type="text"
              required
              value={newWish.name}
            ...
            <button
              type="submit"
              className="w-full py-3 bg-[#2d4a3e] text-white rounded-lg font-elegant hover:bg-[#1a3a2e] transition-colors duration-300"
            >
              Kirim
            </button>
          </form>
        ...
        <div className="space-y-4 text-left">
          {wishes.map((wish, idx) => (
            <div key={idx} className="glass-card p-5 animate-fade-in-up" style={{ animationDelay: `${idx * 0.1}s` }}>
              <div className="flex items-start gap-3">
                <div className="w-10 h-10 rounded-full bg-gradient-to-br from-[#c9a96e] to-[#2d4a3e] flex items-center justify-center flex-shrink-0">
                  <span className="text-white font-display text-sm">{wish.name.charAt(0)}</span>
                </div>
                <div className="flex-1">
                  <div className="flex justify-between items-center mb-1">
                    <h4 className="font-display text-[#2d4a3e] font-semibold">{wish.name}</h4>
                    <span className="font-elegant text-xs text-gray-400">{wish.time}</span>
                  </div>
                  <p className="font-elegant text-gray-600 leading-relaxed">{wish.message}</p>
                </div>
              </div>
            </div>
          ))}
  ...
  return (
    <section className="py-16 px-6 text-center" style={{ background: 'linear-gradient(180deg, #1a3a2e 0%, #0f2a1e 100%)' }}>
      <div className="max-w-2xl mx-auto">
        ...
        <h2 className="font-script text-5xl md:text-6xl text-white mb-2">Ahmad & Fatimah</h2>
        <p className="font-elegant text-[#e8d5a3] tracking-widest">15 • 03 • 2025</p>
...
function FloatingNav() {
  ...
  return (
    <nav className="fixed bottom-4 left-1/2 transform -translate-x-1/2 z-40">
      <div className="flex gap-1 bg-white/90 backdrop-blur-md rounded-full px-4 py-2 shadow-lg border border-[#c9a96e]/20">
        {navItems.map((item) => (
          <a
            key={item.id}
            href={`#${item.id}`}
            onClick={() => setActive(item.id)}
            className={`flex flex-col items-center px-3 py-1 rounded-full transition-all duration-300 ${
              active === item.id ? 'bg-[#2d4a3e] text-white' : 'text-gray-500 hover:text-[#2d4a3e]'
            }`}
          >
            <span className="text-sm">{item.icon}</span>
            <span className="text-[10px] font-elegant hidden md:block">{item.label}</span>
          </a>
        ))}
      </div>
    </nav>
