          ...
          <div className="space-y-6">
            ...
            <div className="bg-white rounded-xl p-6 shadow-sm border border-gray-100">
              <div className="flex items-center justify-between mb-4">
                <div>
                  <h3 className="text-lg font-bold text-gray-800 mb-1">📸 Galeri Foto</h3>
                  <p className="text-sm text-gray-500">
                    {weddingData.galleryPhotos.length}/6 foto terupload
                  </p>
                </div>
                <button
                  onClick={() => setActiveTab('couple')}
              ...
              {weddingData.galleryPhotos.length > 0 ? (
                ...
                <div className="text-center py-8 bg-gray-50 rounded-lg border-2 border-dashed border-gray-200">
                  ...
                  <p className="text-xs text-gray-400 mt-1">Klik "Kelola Galeri" untuk upload foto</p>
                </div>
              )}
            </div>
        ...
        {activeTab === 'couple' && (
          <div className="bg-white rounded-xl p-6 shadow-sm border border-gray-100">
            ...
            <div className="mt-8 pt-8 border-t border-gray-200">
              <h3 className="text-lg font-bold text-gray-800 mb-4">📸 Galeri Foto (Maksimal 6 Foto)</h3>
              <p className="text-sm text-gray-500 mb-6">
                Upload foto untuk ditampilkan di halaman undangan
              </p>

              {/* Foto yang sudah diupload */}
              {weddingData.galleryPhotos.length > 0 && (
                <div className="grid grid-cols-2 md:grid-cols-3 gap-4 mb-6">
                  {weddingData.galleryPhotos.map((photo, index) => (
